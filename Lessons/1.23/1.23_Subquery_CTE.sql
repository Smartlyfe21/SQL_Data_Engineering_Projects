...
--keep only job titles whose median salary is above overall median:
...
--CTE Example
-- compare much more ( or less) remote roles compared onsite pay for each job titles
...
-- Final Example
-- Identify job postings that have no associated skills before them into a data mart
